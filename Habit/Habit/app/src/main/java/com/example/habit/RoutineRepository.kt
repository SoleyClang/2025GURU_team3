    ...
    fun getRoutinesForTheme(theme: ThemeType): List<Routine> {
        return when (theme) {
            ThemeType.HEALTH -> listOf(
                ...
                Routine(2, "30분 운동", "가벼운 운동 또는 산책", false, 20),
                Routine(10, "수면 8시간 이상", "미리 설정한 수면시간 내외로 수면", false, 20),
                Routine(11, "5000걸음 이상 걷기", "미리 설정한 걸음 수 이상 걷기", false, 15),
                Routine(12, "단백질 챙기기", "단백질이 들어간 음식 섭취", false, 10),
                Routine(13, "영양제 챙기기", "영양제 섭취", false, 10)
            )

            ThemeType.SELF_DEV -> listOf(
                Routine(3, "뉴스 읽기", "하루 1개 시사 읽기", false, 10),
                Routine(4, "공부 타이머 1시간", "집중 공부 1시간 이상", false, 20),
                Routine(14, "내일 할 일 리스트 작성", "하루 마무리 전 내일 계획 세우기", false, 10),
                Routine(15, "1줄 일기 / 하루 기록", "감정, 목표, 회고 등 짧은 기록", false, 10),
                Routine(16, "뉴스 읽기 / 시사 요약", "오늘의 이슈 읽고 키워드 정리", false, 10),
                Routine(17, "공부 타이머 1시간", "타이머로 학습 시간 측정", false, 20)
            )
